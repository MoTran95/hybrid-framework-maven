...
public class AddCustomerPageObject extends BasePage {
	...
	public String getCustomerID() {
		waitForElementVisible(driver, addCustomerPageUI.CUSTOMER_ID_TEXT);
		return getElementText(driver, addCustomerPageUI.CUSTOMER_ID_TEXT);
	}

	public editCustomerPageObject clickToEditCustomerPage() {
		waitForElementVisible(driver, addCustomerPageUI.EDIT_CUSTOMER_LINK);
		clickToElement(driver, addCustomerPageUI.EDIT_CUSTOMER_LINK);
		return PageGeneratorManagerBankGuru.getEditCustomerPage(driver);
	}
